...
class TestPromptEnhancementEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_success_includes_cache_control_no_store_header(self, client, mock_of_llama_cpp_client) -> None:
        """
        ...
        v5.12.0 specification, SHOULD-level advisory).
        """
        response = await client.post(
            "/v1/prompts/enhance",
            json={"prompt": "A cat sitting on a windowsill"},
    ...
    @pytest.mark.asyncio
    async def test_original_prompt_echoed_exactly(self, client, mock_of_llama_cpp_client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_response_contains_all_required_fields(self, client, mock_of_llama_cpp_client) -> None:
        response = await client.post(
            "/v1/prompts/enhance",
    ...
    @pytest.mark.asyncio
    async def test_service_unavailable(self, client, mock_of_llama_cpp_client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_enhancement_error(self, client, mock_of_llama_cpp_client) -> None:
    ...
    @pytest.mark.asyncio
    async def test_unexpected_error(self, client, mock_of_llama_cpp_client) -> None:
        mock_of_llama_cpp_client.enhance_prompt.side_effect = RuntimeError("something broke")
