...
def build_prompt_for_analysis_of_commit_message_accuracy(
    ...
    return (
        ...
        "between edits rather than the total delta from the parent.\n"
        "\n"
        "3. **Significant omissions**: The diff contains significant "
        "changes that the message fails to mention entirely.\n"
        "\n"
...
def check_and_build_blocking_message() -> str | None:
    ...
    return (
        ...
        f"Issues found:\n{formatted_issues}\n"
        "\n"
        "The commit message must describe the total changes relative to\n"
        "the parent commit, not relative to an intermediate editing state.\n"
        "\n"
