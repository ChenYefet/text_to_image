...
def build_prompt_for_analysis_of_commit_message_format(
    ...
    return (
        ...
        "3. The Co-Authored-By trailer line at the end is not part of "
        "the body and should be ignored.\n"
        "4. A commit message with only a subject line and no body is "
        "acceptable.\n"
        "\n"
        ...
        "(has header, and body if present uses bullet points).\n"
