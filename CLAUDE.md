...
This principle extends to the body. When a body is needed, each bullet point should describe a decision and its rationale — not enumerate every function added or file touched. The diff already records what was touched; the commit message records what a reader cannot recover from the diff alone.
