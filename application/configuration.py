...
Every configuration variable is documented in the v5.12.0 specification
...
class ApplicationConfiguration(pydantic_settings.BaseSettings):
    ...
    large_language_model_path: str = pydantic.Field(
        ...
        description=(
            ...
            "(§17 of the v5.12.0 specification)."
        ),
    )
    ...
    number_of_consecutive_failures_to_open_circuit_breaker_for_large_language_model: int = pydantic.Field(
        default=5,
        ge=1,
        description=(
