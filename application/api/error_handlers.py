...
The mapping follows the v5.3.0 specification requirements:
...
-----------------------------
Per RFC 9110 §15.5.6 and NFR22 of the v5.3.0 specification, every
...
# machine-readable error codes defined in the v5.3.0 specification
...
# Maps Starlette/FastAPI framework-raised HTTP status codes to the
# specification-defined structured logging event names.  The v5.3.0
...
def register_error_handlers(fastapi_application: fastapi.FastAPI) -> None:
    ...
    async def handle_starlette_http_exception(
        ...
        and NFR22 of the v5.3.0 specification.
        """
        ...
        # The v5.3.0 specification's 46-event logging taxonomy defines
