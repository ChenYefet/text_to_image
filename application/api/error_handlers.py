...
The mapping follows the v5.12.0 specification requirements:
...
-----------------------------
Per RFC 9110 §15.5.6 and NFR22 of the v5.12.0 specification, every
...
# logging event names defined in the v5.12.0 specification (Section 11 —
...
def register_error_handlers(fastapi_application: fastapi.FastAPI) -> None:
    ...
    async def handle_starlette_http_exception(
        ...
        and NFR22 of the v5.12.0 specification.
        """
        ...
        # The v5.12.0 specification's 46-event logging taxonomy defines
