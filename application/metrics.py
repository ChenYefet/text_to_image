...
v5.2.7 specification (FR38 and NFR12):
...
# per endpoint.  The v5.2.7 specification notes that fewer than 10,000
...
class MetricsCollector:
    ...
    def __init__(
        ...
        Args:
            maximum_number_of_observations_per_endpoint: The maximum number of
                ...
                matching the v5.2.7 specification's expected evaluation
    ...
    def snapshot(self) -> dict:
        ...
        the v5.2.7 specification (FR38, Section 11):
...
def _format_current_utc_timestamp() -> str:
    ...
    The format matches the v5.2.7 specification requirement (FR38,
